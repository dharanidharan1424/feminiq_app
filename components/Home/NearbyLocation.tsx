...
const NearbyLocation: React.FC = () => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: getColor("#fff", "#222") }}>
      <ScrollView>
        {openDropdown && (
          <Pressable
            style={{
              ...
              right: 0,
              bottom: 0,
              zIndex: 98, // less than button's zIndex 98
      ...
      <TouchableOpacity
        ...
        onPress={() => router.push("/NearbyLocation")}
      >
