  ...
  return (
    <>
      ...
      >
        ...
        >
          <Text
            className="text-[20px] font-poppins-semibold text-center mb-3"
          ...
          >
            {PROFESSIONAL_TYPES.map((opt) => {
              const isSelected = selectedProfType === opt;
              ...
              return (
                ...
                >
                  <Text
                    style={{
                      color: isSelected ? "white" : PRIMARY_LIGHT,
                      fontFamily: "Poppins_400Regular",
                      marginRight: opt !== "All" ? 4 : 0, // spacing before icon if exists
                    }}
                  >
                    {opt}
                  </Text>
